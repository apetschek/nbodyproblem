...
# Runge-Kutta solver 4th order (fixed time step)
...
# Runge-Kutta-Fehlberg 5th order (Fixed timestep) 
...
# Runge-Kutta solver ver 8th order (fixed time step)
...
# Runge-Kutta-Fehlberg 5th order (Adaptive timestep) 
...
# Stromer-Verlet leapfrog 2nd order
...
# Forest-Ruth leapfrog 4th order
